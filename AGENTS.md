...
This is a Java implementation of a Codex-style Agent learning project. The project uses a progressive learning approach with stages S01-S12 (and SFull), each incrementally introducing new capabilities. The core architecture separates runtime execution from capability configuration, allowing the same AgentRuntime to support different feature levels through StageConfig.
